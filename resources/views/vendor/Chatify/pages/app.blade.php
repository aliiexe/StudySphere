    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-body contacts-container">
           ...
           <div class="messenger-tab search-tab app-scroll" data-view="search">
                {{-- items --}}
                <p class="messenger-title"><span>Rehcercher</span></p>
                <div class="search-records">
                    <p class="message-hint center-el"><span>Ecrivez pour chercher</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            ...
            <div class="internet-connection">
                ...
                <span class="ic-connecting">En cours de connection...</span>
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Selectionner un chat pour commencer</span></p>
            </div>
            {{-- Typing indicator --}}
