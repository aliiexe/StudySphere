...
<body class="bg-gradient">
    ...
    <div class="container max-w-2xl mx-auto bg-white rounded-lg shadow-md mt-10 p-8">
        <h1 class="text-2xl font-bold text-indigo-600 mb-6">Créer un post</h1>
        <form action="{{ route('store_post') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="content" id="content" class="w-full px-4 py-2 border border-gray-300 rounded resize-none" required></textarea>
            </div>
            <div class="mb-4">
            ...
            <button type="submit" class="w-full inline-block py-3 bg-indigo-600 text-white rounded-full transition duration-300 hover:bg-indigo-800 focus:outline-none focus:shadow-outline-indigo">Submit</button>
        </form>
