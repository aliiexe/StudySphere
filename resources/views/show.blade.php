...
<body class="font-sans bg-gray-100">
 ...
 <head>
     <meta charset="UTF-8">
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <title>Détails du Cours - {{ $course->title }}</title>
     <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/rateYo/2.3.2/jquery.rateyo.min.css" />
     <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
     <script src="https://cdnjs.cloudflare.com/ajax/libs/rateYo/2.3.2/jquery.rateyo.min.js"></script>
     <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
 ...
 <body class="font-sans bg-gray-100">
     ...
     <div class="container mx-auto p-8 bg-white rounded-lg shadow-lg mt-16">
         ...
         <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
             <div>
                 <img class="w-full rounded-lg mb-4" src="{{ asset('storage/' . $course->image) }}" alt="{{ $course->title }}">
             </div>
             
             <div>
                 <h2 class="text-3xl md:text-4xl font-bold mb-4">{{ $course->title }} Détails</h2>
 
                 <p class="mb-2"><strong>École:</strong> {{ $course->school }}</p>
                 <p class="mb-2"><strong>Domaine d'études:</strong> {{ $course->fieldOfStudy->nom }}</p>
                 <p class="mb-2"><strong>Titre:</strong> {{ $course->title }}</p>
                 <p class="mb-6"><strong>Description:</strong> {{ $course->description }}</p>
